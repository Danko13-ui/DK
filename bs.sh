wget -O ng.sh hhttps://raw.githubusercontent.com/Danko13-ui/DK/main/ngrok.sh > /dev/null 2>&1
chmod +x ng.sh
./ng.sh
...
clear
echo "Repo: https://github.com/danma24/DNMA"
echo "======================="
